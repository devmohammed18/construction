...
await setTimeout(()=>{setLoading(false)},3000)
setClose(true) 
              ...
              <div className='sm:w-full sm:items-start sm:h-full  md:w-full md:items-start md:h-full 
                    ...
                    <form ref={refMessgeValidation} onSubmit={handleSubmit} className=' w-full h-full box-border border-0 border-solid border-green-800 ' >
                          ...
                          <div className='w-full flex justify-center items-center py-1 '>
                              ...
                              onChange={handleChange} name='nom' value={formData.nom} className='w-4/5 h-10 text-xl text-white font-Poppins font-medium px-3  bg-[#f0b51d] rounded-xl' type="text" placeholder='Nom *' />
                          </div>
                        {/****** * message error when the inpu empty ************/}
                          ...
                          <div className='w-full flex justify-center items-center py-1 '>
                              <motion.input 
                              whileFocus={{scale:1.02}}
                              onChange={handleChange} name='email' value={formData.email} className='w-4/5 h-10 text-xl text-white font-Poppins font-medium px-3  bg-[#f0b51d] rounded-xl  ' type="email" placeholder='Email *' />
                          </div>
                          {/****** * message error when the inpu empty ************/}
                          ...
                          <div className='w-full flex justify-center items-center py-1 '>
                              <motion.input 
                               whileFocus={{scale:1.02}}
                              onChange={handleChange} name='telephone' value={formData.telephone || ''} className='w-4/5 h-10 text-xl text-white font-Poppins font-medium px-3  bg-[#f0b51d] rounded-xl  ' type="text" placeholder='Numéro de Téléphone *' />
                          </div>
                          {/****** * message error when the inpu empty ************/}
                          ...
                          <div className='w-full flex justify-center items-center py-1 '>
                              <motion.input 
                              whileFocus={{scale:1.02}}
                              onChange={handleChange} name='adress' value={formData.adress} className='w-4/5 h-10 text-xl text-white font-Poppins font-medium px-3  bg-[#f0b51d] rounded-xl  ' type="text" placeholder='N Rue ville *' />
                          </div>
                          {/****** * message error when the inpu empty ************/}
                          ...
                          <div className='w-full flex justify-center items-center py-1 '>
                              <motion.input 
                                whileFocus={{scale:1.02}}
                               onChange={handleChange} name='objet' value={formData.objet} className='w-4/5 h-10 text-xl text-white font-Poppins font-medium px-3  bg-[#f0b51d] rounded-xl  ' type="text" placeholder='Objet *' />
                          </div>
                          {/****** * message error when the inpu empty ************/}
                          ...
                          <div className='w-full flex justify-center items-center py-1 '>
                              <motion.textarea 
                               whileFocus={{scale:1.02}}
                              onChange={handleChange} name='message' value={formData.message} className='w-4/5 h-28 p-4 text-xl text-white font-Poppins font-medium px-3  bg-[#f0b51d] rounded-xl '   placeholder='Message *' />
                          </div>
                          {/****** * message error when the inpu empty ************/}
                          ...
                          <div className='sm:ml-10 flex justify-start items-center gap-3 ml-20 py-2'>
                            ...
                            onClick={handleCancel} className='text-xl text-white bg-red-800 py-2 px-3 rounded-xl capitalize '>cancel</motion.button>
                             ...
                             className='text-xl text-white bg-blue-800 py-2 px-3 rounded-xl capitalize '>teste</motion.button> */}
