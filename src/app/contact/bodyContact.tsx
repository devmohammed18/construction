  ...
  return (
    ...
    w-full  flex justify-center gap-2 items-centre bg-slate-900 border-0 border-red-900 border-solid p-4 relative '>
        ...
        <div className='sm:w-full md:w-full w-2/5 flex  justify-center items-center pt-10 pb-5 gap-5 bg-[var(--primary-color)]  border-0 border-solid  border-[var(--treed-color)]  '>
             <div className='flex flex-col justify-center items-start gap-5 ' >
                ...
                <div className="flex justify-start items-center gap-3 text-2xl text-[var(--treed-color)] pb-3 ">
                      ...
                      <h1 className='text-[var(--secondary-color)]' >438 224 5515</h1>
                </div>
                

                <div className='flex justify-start items-center gap-3 text-2xl text-[var(--treed-color)] pb-3  '>
                  <span>  <TfiEmail /></span>
                  <h1 className='text-[var(--secondary-color)]' >Riad@gmail.com</h1>
                </div>
              </div>
        ...
        {close && <div  className='top-0 bottom-0 left-0 right-0 absolute bg-slate-900 opacity-85 '   >
            ...
            <div className='sm:h-60 mx-auto w-4/5  flex flex-col justify-center translate-y-3/4  items-center gap-3 py-10 border-2 border-solid border-[var(--success-color)]'>
                
                    <span onClick={()=>setClose(false)} className='sm:-right-4 sm:-top-28 md:-right-10 text-lg text-[var(--success-color)] -top-20 -right-20 border-2 border-solid border-[var(--success-color)] p-2 rounded-full absolute'>
                        <FaTimes />
                    </span>
                    { loading?<Loading />:
                    <>  
                    <svg className='h-20 w-20 text-[var(--success-color)]' fill="currentColor" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 549.41 549.08">
                    ...
                    <h1 className='sm:text-center md:text-center text-xl text-[var(--success-color)]'>Nous vous remercions pour votre demande. Nous vous contacterons sous 48 heures.</h1>
                    </>
                    }
